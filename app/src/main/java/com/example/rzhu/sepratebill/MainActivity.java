...
public class MainActivity extends Activity {
    ...
    private Button tip_20, tip_15, tip_10, tip_0, toggleBtn;

    private TextView numPadDel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numPadDel = (TextView) findViewById(R.id.bill_del);
        ...
        number_pad = (TableLayout) findViewById(R.id.num_pad);
        share_num_pad = (TableLayout) findViewById(R.id.share_pad);
        ...
        display_layout = (RelativeLayout) findViewById(R.id.display_layout);
...
//                        break;
        ...
        numPadDel.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        //plus one people to share, maximum 99
        ...
        //minus one people to share, minimum 1
...
//            newView = tip_number_pad;
    ...
    private void toggleBillTipBtn() {
        ...
        if (currentState == STATE_BILL) {
            ...
            toggleBtn.setBackground(getDrawable(R.drawable.tip_to_bill_btn));
            clearTipSelectState();
            ...
            toggleBtn.setBackground(getDrawable(R.drawable.bill_to_tip_btn));
            currentState = STATE_BILL;
        }
    ...
    private void clearWaveAnimation() {
        ...
        if (cover.getVisibility() == View.GONE && display_layout.getVisibility() == View.VISIBLE) {
            int cx = 0;
            int cy = display_layout.getHeight();
            // create the animator for this view (the start radius is zero)
            Animator anim = ViewAnimationUtils.createCircularReveal(cover, cx, cy, 0, display_layout.getWidth() * 2);
    ...
    private void revealResultAnimation() {
        if (display_layout.getVisibility() == View.GONE) {
            int cx = display_layout.getWidth();
            int cy = display_layout.getHeight();
            // create the animator for this view (the start radius is zero)
            Animator anim = ViewAnimationUtils.createCircularReveal(display_layout, cx / 2, cy / 2, 0, display_layout.getWidth());
            anim.setDuration(getResources().getInteger(R.integer.clear_reveal_time));
            anim.addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
